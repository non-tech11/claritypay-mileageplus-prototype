        ...
        (highlight ? (
          <div className="mt-2">
            <LoyaltyCard
              ...
              tierName=""
              balance={0}
              chipText={`${theme.programName} exclusive: earn ${preview.data.totalBase.toLocaleString()} ${theme.unit} · +${preview.data.maxFinancingMiles.toLocaleString()} bonus with a monthly plan`}
            />
          </div>
        ) : (
          <p className="mt-2">
