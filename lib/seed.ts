...
function seedLoans(): Loan[] {
  const healthy: Loan = {
    ...
    ledger: [
      ...
      },
      {
        ...
        amount: 500,
        status: "posted",
        reason: "Pay-over-time bonus — posted after first on-time payment",
        date: "2026-08-16",
      },
    ],
    travellers: [
  ...
  const cancelled: Loan = {
    ...
    dpd: 0,
    lateFee: 0,
    refundedToOriginalMethod: 84.3,
    schedule: [
      { idx: 0, dueDate: "2026-07-29", amount: 84.3, status: "refunded", paidAt: "2026-07-29" },
      { idx: 1, dueDate: "2026-08-12", amount: 84.3, status: "cancelled" },
      { idx: 2, dueDate: "2026-08-26", amount: 84.3, status: "cancelled" },
      { idx: 3, dueDate: "2026-09-09", amount: 84.3, status: "cancelled" },
    ],
    ledger: [
      {
        id: "ME-S3",
      ...
      },
      {
        ...
        amount: 500,
        status: "reversed",
        reason: "Booking cancelled within hold window",
        date: "2026-07-16",
      },
      {
        id: "ME-S5",
        ...
        amount: -500,
        status: "posted",
        reason: "Cancellation reversal — bonus removed",
        date: "2026-08-04",
      },
    ],
    travellers: [
    ...
    documents: [
      ...
      { id: "doc-ref-1", title: "Refund confirmation", note: "$84.30 to original method" },
    ],
...
function seedMetrics(): MerchantMetrics {
  ...
  return {
    ...
    avgOrderCard: 418,
    bonusMilesIssued: 1374500,
    bonusMilesReversed: 41200,
    reversalRatePct: 3.0,
    dpd30PlusPct: 2.1,
    gmvSeries,
  };
