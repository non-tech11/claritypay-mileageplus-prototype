  ...
  const healthy: Loan = {
    ...
    ledger: [
      ...
      },
      {
        ...
        amount: 500,
        status: "posted",
        reason: "Economy Plus pay-over-time bonus — posted after first on-time payment",
        date: "2026-08-16",
      },
      {
        id: "ME-S2B",
        ...
        amount: 800,
        status: "posted",
        reason: "Miles back on financed amount (Economy Plus rate) — posted after first on-time payment",
        date: "2026-08-16",
      },
    ],
    travellers: [
