  ...
  const healthy: Loan = {
    ...
    ledger: [
      ...
      },
      {
        ...
        amount: 500,
        status: "pending",
        reason: "Economy Plus pay-over-time bonus — credits after your final payment (Aug 2027)",
        date: "2026-08-16",
      },
      {
        id: "ME-S2B",
        ...
        amount: 800,
        status: "pending",
        reason: "Miles back on financed amount (Economy Plus rate) — credits after your final payment (Aug 2027)",
        date: "2026-08-16",
      },
    ],
    travellers: [
  ...
  const cancelled: Loan = {
    ...
    ledger: [
      ...
      },
      {
        ...
        travellerId: "priya",
        travellerName: "Priya",
        type: "miles_back_reversal",
        amount: -450,
        status: "posted",
        reason: "Cancellation reversal — miles back removed",
        date: "2026-08-04",
      },
    ],
    travellers: [
  ...
  const delinquent: Loan = {
    ...
    ledger: [
      ...
      },
      {
        ...
        amount: 450,
        status: "held",
        reason: "Miles back held at 30+ days past due",
        date: "2026-08-10",
      },
    ],
    travellers: [
